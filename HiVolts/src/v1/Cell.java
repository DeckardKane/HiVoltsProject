...
public class Cell extends JPanel {
	...
	public void draw(int x_offset, int y_offset, int width, int height,
			Graphics g) {
		draw(myX, myY, x_offset, y_offset, width, height, myColor, g);
	}

	public static void draw(int x, int y, int x_offset, int y_offset,int width, int height, Color c, Graphics g) {
